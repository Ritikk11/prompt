      ...
      <div className={`mx-auto ${toolGridWidth}`}>
        ...
        <ScrollReveal stagger className={`mx-auto grid gap-6 ${toolGridCols}`}>
          {tools.map((tool, index) => {
            ...
            return (
              <Link key={tool} href={`/tool/${encodeURIComponent(tool.toLowerCase())}`} prefetch={true} className="group glass-card flex h-full flex-col p-6 transition hover:scale-[1.02] hover:border-primary-400/60 hover:shadow-2xl dark:hover:border-primary-400/50">
