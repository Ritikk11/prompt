...
import { ArrowRight, Crown, Heart, Sparkles, Tag, Wand2 } from 'lucide-react';
  ...
  return (
    <section className="relative left-1/2 w-screen -translate-x-1/2 overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-800 to-rose-800 px-5 py-16 text-white sm:px-8">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <div className="mx-auto mt-8 rounded-[28px] border border-white/15 bg-white/10 p-5 text-left shadow-2xl backdrop-blur-md sm:p-7">
