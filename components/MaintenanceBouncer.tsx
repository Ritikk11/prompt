...
export default function MaintenanceBouncer({ isMaintenanceMode }: { isMaintenanceMode?: boolean }) {
  ...
  return (
    <div className="fixed inset-0 z-[10000] bg-white/25 dark:bg-white/[0.08] flex flex-col items-center justify-center p-6 backdrop-blur-xl backdrop-saturate-150">
