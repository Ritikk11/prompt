        ...
        <div className="mt-7 grid w-full max-w-4xl grid-cols-2 gap-3.5 sm:mt-10 md:grid-cols-4">
          {statItems.map(item => {
            ...
            return (
              <div
                key={item.label}
                className="group glass-card relative overflow-hidden p-3.5 text-left backdrop-blur-2xl transition-all duration-300 ease-out hover:scale-[1.03] hover:border-primary-400 hover:shadow-xl dark:hover:border-primary-400/60 sm:p-4"
              >
