...
export default function ArticleCard({ article, thumbnailUrl }: { article: Article; thumbnailUrl?: string }) {
  ...
  return (
    <Link
      href={href}
      className="group flex h-full flex-col overflow-hidden rounded-[22px] border border-transparent bg-white p-3 shadow-[0_2px_10px_rgba(15,23,42,0.10)] transition hover:-translate-y-1 hover:shadow-[0_18px_38px_-18px_rgba(79,70,229,0.45)] dark:bg-surface-900"
    >
