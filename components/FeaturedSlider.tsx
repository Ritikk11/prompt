...
import { ChevronLeft, ChevronRight, Play, Pause, Eye, Heart, ArrowRight, Bookmark, Flame, Sparkles, Wand2 } from 'lucide-react';
...
export default function FeaturedSlider({
  ...
  const promptImageUrl = (item?: Post, fallback = '') => (
          ...
          <div className="perspective-1000 order-1 relative h-[300px] w-full md:order-2 md:h-[400px] md:w-1/2">
             {featured.map((p, i) => {
               ...
               return (
                 ...
                 >
                   <Image src={promptImageUrl(p)} alt={`bg-${p.title}`} fill sizes="20vw" className="scale-125 object-cover opacity-50 blur-xl" referrerPolicy="no-referrer" />
                   <LoadingImage
