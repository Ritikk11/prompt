...
export default function GlmCreatorFeedback({ settings }: { settings?: SiteSettings }) {
  ...
  return (
    <section className="relative w-full overflow-clip px-5 py-16 sm:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <GlmReveal stagger className="mx-auto grid max-w-5xl gap-5 md:grid-cols-2">
          {items.map(item => (
            <div key={item.title} className={`${glassCard} p-6 transition hover:border-primary-400/60 dark:hover:border-primary-400/50`}>
