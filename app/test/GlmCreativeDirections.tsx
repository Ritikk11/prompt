...
import type { CreativeDirectionItem, PostSummary, SiteSettings } from '@/lib/types';
import { GlmSectionHeader } from './GlmSection';
...
function countMatches(posts: PostSummary[], item: CreativeDirectionItem) {
...
export default function GlmCreativeDirections({ posts, settings }: { posts: PostSummary[]; settings?: SiteSettings }) {
  ...
  return (
    <section className="relative w-full overflow-clip px-5 py-16 sm:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <GlmReveal stagger className="flex flex-wrap items-center justify-center gap-3">
