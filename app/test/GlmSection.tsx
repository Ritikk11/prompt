...
export const glassSurface =
  'border border-white/80 bg-white/60 backdrop-blur-lg backdrop-saturate-[160%] dark:border-white/10 dark:bg-white/[0.08] transform-gpu [backface-visibility:hidden]';
