...
const article: Article = {
  ...
  title: 'The Biggest AI Photo Trends of 2026 (With Prompt Ideas)',
  description:
  ...
  category: 'blog',
  tags: ['trends', 'ai photos', 'social media', 'prompt ideas'],
  readMinutes: 8,
...
For box text options, accessory ideas, and fixes for common failures (melted faces, gibberish label text), see the full [3D figurine photo trend guide](/guides/3d-figurine-photo-trend-guide).
...
A starter direction: describe a woman in a flowing chiffon saree standing on a rooftop at golden hour, wind moving the fabric, 90s film grain, warm faded colors, cinematic 35mm look. The detailed version — including color-grade wording and pose ideas — is in our [retro saree portrait guide](/guides/retro-saree-portrait-guide).
...
The key skill is keeping the face recognizably yours while changing everything else; our [AI headshots guide](/guides/ai-headshots-guide) covers the wording that preserves identity, and the broader technique overlaps with [keeping characters consistent across images](/blog/consistent-characters-ai-images).
...
For sub-style breakdowns and wording that controls the level of stylization, see the [anime portrait prompts guide](/guides/anime-portrait-prompts-guide).
...
If you want ready-made starting points, browse the [explore page](/explore) for copy-ready prompts across all of these styles, or jump straight to the [Gemini prompts](/tool/gemini) collection — Gemini's photo-editing mode is particularly strong for the reference-photo trends on this list.
...
Personal posting is generally fine under major tools' terms. For commercial use — ads, merchandise, client work — check the tool's current terms and avoid images containing other identifiable people; see our plain-language guide to [who owns AI-generated images](/blog/who-owns-ai-generated-images).
`,
};
